...
(custom-set-faces
 ...
 '(jabber-chat-prompt-foreign ((t (:foreground "red"))) t)
 '(jabber-chat-prompt-local ((t (:foreground "blue"))) t)
 '(jabber-chat-prompt-system ((t (:foreground "dark green" :weight bold))) t)
 '(jabber-roster-user-away ((t (:foreground "orange"))) t)
 '(jabber-roster-user-chatty ((t (:foreground "green"))) t)
 '(jabber-roster-user-online ((t (:foreground "dark green"))) t))
