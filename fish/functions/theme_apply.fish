function theme_apply -d "Apply tide+fzf colors for current macOS appearance"
    ...
    if test "$mode" = dark
        ...
        set -U tide_character_color A06D00
        set -U tide_character_color_failure BF0021

        set -U tide_pwd_color_anchors 465AA4
        set -U tide_pwd_color_dirs 7892BD
        set -U tide_pwd_color_truncated_dirs A98A78

        set -U tide_git_color_branch 465AA4
        set -U tide_git_color_conflicted BF0021
        set -U tide_git_color_dirty A06D00
        set -U tide_git_color_operation BC5C00
        set -U tide_git_color_staged 3A684A
        set -U tide_git_color_stash 465AA4
        set -U tide_git_color_untracked 3A684A
        set -U tide_git_color_upstream 465AA4

        set -U tide_status_color 3A684A
        set -U tide_status_color_failure BF0021
        set -U tide_cmd_duration_color 7D6658
        set -U tide_jobs_color A06D00
        set -U tide_time_color 7D6658

        set -U tide_context_color_default 7D6658
        set -U tide_context_color_root BF0021
        set -U tide_context_color_ssh 465AA4

        set -U tide_direnv_color A06D00
        set -U tide_direnv_color_denied BF0021

        set -U tide_vi_mode_color_default 465AA4
        set -U tide_vi_mode_color_insert 3A684A
        set -U tide_vi_mode_color_replace BF0021
        set -U tide_vi_mode_color_visual 904180

        set -U tide_bun_color 7892BD
        set -U tide_node_color 3A684A
        set -U tide_python_color 3D6568
        set -U tide_rustc_color BC5C00
        set -U tide_java_color BC5C00
        set -U tide_php_color 7892BD
        set -U tide_pulumi_color A06D00
        set -U tide_ruby_color BF0021
        set -U tide_go_color 465AA4
        set -U tide_gcloud_color 465AA4
        set -U tide_kubectl_color 465AA4
        set -U tide_aws_color A06D00
        set -U tide_nix_shell_color 7892BD
        set -U tide_terraform_color 904180
        set -U tide_elixir_color 904180
        set -U tide_zig_color BC5C00
