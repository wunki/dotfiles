;;; Funki theme.
;;;
;;; An adaptation from funki-theme
;;;

;; Author: Petar Radosevic
;; Version: 0.0.2
;; Package-Version: 20171118.437
;; Package-Requires: ((emacs "24"))
;; URL: https://github.com/wunki/funki
...
(let ((ct '((class color) (min-colors 89)))
  ...
  (let* ((bg              "#1b182c")
    ...
    (custom-theme-set-faces
     ...
     `(funki-minibuffer-active ((,c (:background ,bg))
                                          (,ct (:background ,ct-bg))))
     `(funki-nlinum-highlight  ((,c (:foreground ,linum-hl-fg :bold nil))
                                          (,ct (:foreground ,ct-linum-hl-fg :bold nil))))
     `(funki-flycheck-error    ((,c (:underline nil :foreground ,black :background ,red))))
     `(funki-flycheck-warning  ((,c (:underline nil :foreground ,black :background ,yellow))
                                          (,ct (:underline nil :foreground ,black :background ,yellow))))
     `(funki-flycheck-info     ((,c (:underline nil :foreground ,black :background ,green))))
     ;; Base
     ...
     `(font-lock-comment-face           ((,c (:foreground ,comments :slant italic))
                                         (,ct (:foreground ,ct-comments :slant italic))))
     `(font-lock-comment-delimiter-face ((,c (:foreground ,comments :slant italic))
                                         (,ct (:foreground ,ct-comments :slant italic))))
     `(font-lock-doc-face               ((,c (:foreground ,doc-comments :slant italic))
                                         (,ct (:foreground ,ct-doc-comments :slant italic))))
     `(font-lock-doc-string-face        ((,c (:foreground ,doc-comments :slant italic))
                                         (,ct (:foreground ,ct-doc-comments :slant italic))))
     ...
     `(funki-modeline-buffer-path       ((,c (:foreground ,cyan :bold ,bold))
                                                   (,ct (:foreground ,ct-cyan :bold ,bold))))
     `(funki-modeline-buffer-project    ((,c (:foreground ,fg))
                                                   (,ct (:foreground ,ct-fg))))
     `(funki-modeline-buffer-modified   ((,c (:foreground ,red))
                                                   (,ct (:foreground ,ct-red))))
     `(funki-modeline-buffer-major-mode ((,c (:foreground ,blue :bold ,bold))
                                                   (,ct (:foreground ,ct-blue :bold ,bold))))
     `(funki-modeline-highlight     ((,c (:foreground ,blue))
                                               (,ct (:foreground ,ct-blue))))
     `(funki-modeline-panel         ((,c (:foreground ,black :background ,blue))
                                               (,ct (:foreground ,ct-black :background ,ct-blue))))
     `(funki-modeline-bar           ((,c (:background ,blue))
                                               (,ct (:background ,ct-blue))))
     `(funki-modeline-eldoc-bar     ((,c (:background ,yellow))
